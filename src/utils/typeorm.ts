...
import { Project, User, Issue, Comment, Client } from 'entities';
import { EntityNotFoundError, BadUserInputError } from 'errors';
import { generateErrors } from 'utils/validation';

type EntityConstructor = typeof Project | typeof User | typeof Issue | typeof Comment | typeof Client;
type EntityInstance = Project | User | Issue | Comment | Client;

const entities: { [key: string]: EntityConstructor } = { Comment, Issue, Project, User, Client };
